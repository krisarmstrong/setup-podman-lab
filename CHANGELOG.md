...
## [1.2.0](https://github.com/krisarmstrong/setup-podman-lab/compare/v1.1.0...v1.2.0) (2026-06-17)
...
* **ci:** add missing noxfile and correct matrix python-version ([#9](https://github.com/krisarmstrong/setup-podman-lab/issues/9)) ([c172ed4](https://github.com/krisarmstrong/setup-podman-lab/commit/c172ed4625dad4b46a10ba595d4b89f515d922ac))
...
* refreshed repo layout, docs, and test scaffolding
...
* use verbose output in CI for debugging ([faedcb3](https://github.com/krisarmstrong/setup-podman-lab/commit/faedcb33ce900752200f4180e09e56596f59cec1))

## [1.0.3](https://github.com/krisarmstrong/setup-podman-lab/compare/v1.0.2...v1.0.3) (2025-11-02)


### Bug Fixes

* use direct shellcheck instead of action ([fb183bd](https://github.com/krisarmstrong/setup-podman-lab/commit/fb183bd381919bc3763dc51491143ed41b7067c1))
